...
<div id="wrapper">
    ...
    <!-- Sidebar -->
    @include('layouts.side' , ['slag' => 3 , 'subSlag' => 402])
    <!-- End of Sidebar -->
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4 " style="padding: 8px">
                    <h1 class="h3 mb-0 text-primary-800 no-print">{{__('main.item_list')}} / {{__('main.print_qrcode')}}</h1>
                </div>
                                    ...
                                    <div class="item style50" style="width:2in;height: 1in;border:0;">
                                        <div class="div50" style="width:2in;height:1in;border: 1px dotted #CCC;padding-top:0.025in;">
                                            <img id='barcode'
                                                 ...
                                                 alt=""
                                                 title="{{Config::get('app.locale') == 'ar' ?  $item['name_ar'] : $item['name_en']}}"
                                                 width="90"
                                                 height="90" />
                                        </div>
                                    </div>
