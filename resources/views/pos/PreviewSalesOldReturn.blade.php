            ...
            <div class="container-fluid">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4" style="padding: 8px">
                    <h1 class="h3 mb-0 text-primary-800 no-print">{{__('main.return_sales')}}
                        / {{__('main.return_sales_old_preview')}}</h1>
                </div>
                    ...
                    <div class="row">
                        <div class="card shadow mb-4 col-9">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary no-print">{{__('main.return_sales_old_preview')}}</h6>
                                <br>
                                <a href="{{route('oldReturnPrint' , $bill -> id)}}" target="_blank">
