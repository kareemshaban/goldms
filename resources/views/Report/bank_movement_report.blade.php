        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4" style="padding: 8px">
                    <h1 class="h3 mb-0 text-primary-800">{{__('main.reports')}} / {{__('main.bank_movement_report')}}</h1>
                ...
                <div class="card-body px-0 pt-0 pb-2">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">{{__('main.bank_movement_report')}}</h6>
                        </div>
                        <div class="card-body">
